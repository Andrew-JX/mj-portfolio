  ...
  <div class="space-y-10">
    <section class="space-y-4">
      ...
      <p class="text-slate-300 leading-relaxed max-w-3xl">
        我主要方向是 Web 大前端，偏工程交付与可视化：Vue3/TypeScript 工程化开发、Cesium/EarthSDK 三维交互组件封装，
        以及 Android（Compose）端侧能力。目标岗位：大前端工程师。
      </p>
      ...
      <div class="flex flex-wrap gap-2 pt-2">
        ...
        <span class="px-2.5 py-1 rounded-full text-xs bg-slate-900 border border-slate-800">Android Compose</span>
      </div>
    </section>

    <section class="grid md:grid-cols-3 gap-4">
      <div class="rounded-2xl bg-slate-900/40 border border-slate-800 p-5">
        <div class="font-semibold">三维可视化工程</div>
        <p class="text-sm text-slate-300 mt-2">
          Cesium/EarthSDK 三维场景与交互工具；将测量/体积/分析能力做成可复用组件，并处理多 SDK 版本兼容问题。
        </p>
      </div>

      <div class="rounded-2xl bg-slate-900/40 border border-slate-800 p-5">
        <div class="font-semibold">业务前端工程化</div>
        <p class="text-sm text-slate-300 mt-2">
          Vue3 + Router + 状态管理；模块化页面、可维护结构、部署上线（能给出可访问链接或可复现仓库）。
        </p>
      </div>

      <div class="rounded-2xl bg-slate-900/40 border border-slate-800 p-5">
        <div class="font-semibold">多端能力补强</div>
        <p class="text-sm text-slate-300 mt-2">
          Kotlin/Jetpack Compose + MVVM；Room/Retrofit；WorkManager/AlarmManager 做后台任务与提醒。
        </p>
      </div>
    </section>
    ...
    <section class="rounded-2xl bg-slate-900/40 border border-slate-800 p-6 space-y-3">
      ...
      <div class="text-sm text-slate-300 leading-relaxed space-y-1">
        ...
        <div class="pt-2">
          联系：<span class="text-slate-200">JX15996596656@163.com</span>
          <div class="pt-2">
            gitHub: <a class="text-slate-300 hover:text-white" href="https://github.com/Andrew-JX/" target="_blank"
              rel="noreferrer">Andrew-JX</a>
          </div>
          <div class="pt-2">gitee: <a class="text-slate-300 hover:text-white" href="https://gitee.com/ji-minyu"
              target="_blank" rel="noreferrer">ji-minyu</a>
          </div>
        </div>
      </div>
    </section>
