...
export const projectMediaMap: Record<string, ProjectMedia> = {
  ...
  'cat-note-illustrations': {
    ...
    eyebrow: 'AI content skill',
    title: 'Visual notes',
    caption: 'Article structure and key ideas translated into a consistent cat-note illustration system.',
    metrics: ['Prompt', 'Visual QA', 'Skill'],
    tone: 'sunset',
  },
  quickdate: {
    slug: 'quickdate',
    eyebrow: 'Lightweight web product',
    title: 'Invite flow',
    caption: 'A playful invitation, response, and calendar-card loop designed for easy sharing.',
    metrics: ['Static H5', 'URL state', 'Dual deploy'],
    tone: 'violet',
  },
  pureip: {
    slug: 'pureip',
