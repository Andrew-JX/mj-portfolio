...
export const toolShares: ToolShare[] = [
  ...
  {
    id: 'deploy-static-site-to-tencent',
    name: 'Deploy Static Site to Tencent',
    kind: 'skill',
    origin: 'self',
    categoryId: 'orchestration-connectors',
    status: '尚未实测',
    usedIn: '本站部署机制已真实跑通；Skill 尚未在第二个项目调用',
    source: '从 mj-portfolio 腾讯云上线、GitHub Actions 首次失败与修复中提炼',
    intrusion: 'L4 · GitHub Actions、受限 SSH、root-owned 服务器脚本与远程发布',
    lastChecked: '2026-08-10',
    summary: '把静态站从 GitHub main 推送到腾讯云 nginx 的构建、受限上传、原子切换、回滚和健康检查压成可调用流程。',
    replaces: '手工构建、scp 上传、nano 改配置和凭记忆检查线上结果。',
    goodAt: '底层流程已在本站真实跑通；Skill 设计目标是复用强制命令 SSH、归档校验、原子发布与失败回滚。',
    badAt: 'Skill 的第二项目复用与自动触发尚未实测；完整产物跨境上传受 3 Mbps 带宽影响，本站首次成功 run 约 7 分钟。',
    boundary: '只处理静态站，不覆盖后端重启、数据库迁移或多服务编排；生产写入、GitHub Secrets 与 push 必须单独获得授权。',
    tags: ['Self-built', 'GitHub Actions', 'Tencent Cloud', 'Restricted SSH'],
    installNote: '源码随本站仓库维护：tooluse/skills/deploy-static-site-to-tencent。',
  },
  {
    id: 'work-skill',
    name: 'work-skill',
